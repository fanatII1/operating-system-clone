...
const initialState = {
  ...
  pinnedApps: [
    ...
    },
    {
      ...
      onClick: () => {
        const textMessage = encodeURIComponent(
          "GoodDay Mandlenkosi Marwanqana!, [your message here]"
        );
        window.open(
          `https://wa.me/+27813272285?text=${textMessage}`,
          "_blank",
          WIN_FEATURES
        );
      },
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://www.google.com/search?q=fanatii1+github",
          "_blank",
          WIN_FEATURES
        );
      },
  ...
  shortcutApps: [
    ...
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://www.linkedin.com/in/mandlenkosi-marwanqana-b08357218/",
          "_blank",
          WIN_FEATURES
        );
      },
    ...
    },
    {
      ...
      onClick: () => {
        const textMessage = encodeURIComponent(
          "Good Day Mandlenkosi Marwanqana!, [your message here]"
        );
        window.open(
          `https://wa.me/+27813272285?text=${textMessage}`,
          "_blank",
    ...
    },
    {
      ...
      width: 35,
      height: 35,
      onClick: () => (window.location.href = "mailto:d=mandlankosi739@gmail.com@gmail.com"),
    },
    // {
    //   name: "Search",
